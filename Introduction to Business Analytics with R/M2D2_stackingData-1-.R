...
rightSide <- allItems[,c(13:21)]            # Put the last 12 columns into a new dataframe, rightSide
...
j13$CashierName <- 1:nrow(j13)        # Creates a new column in j13 equal to a series of numbers from 1 to the number of rows in j13
...
j13$CashierName <- rep(NA, nrow(j13))  # Replaces the StoreCode column with a column of NAs
